<%@ Page Title="" Language="C#" MasterPageFile="~/cake.Master" AutoEventWireup="true" CodeBehind="Supplier.aspx.cs" Inherits="Gk_Cake_shop.Supplier"%>
                                            ...
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <div class="row">
                                                     ...
                                                     <asp:Label ID="lbl_SuppplierFormError" runat="server" ForeColor="Red" Font-Bold="true" Font-Size="Large" Visible="false"></asp:Label>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-lg-6">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter SupplierName" 
                                                                    ControlToValidate="txt_SupplierName" ForeColor="Red" ValidationGroup="PersonalGroup"></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col-lg-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-lg-6">
                                                                 ...
                                                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please enter mobile number" 
                                                                     ControlToValidate="txt_SupplierMobileNo" ValidationExpression="[0-9]{10}" ForeColor="Red" ValidationGroup="PersonalGroup"></asp:RegularExpressionValidator>
                                                            </div>
                                                         </div>
                                                         
                                                        <div class="row">
                                                         <div class="text-left">
                                                             <asp:Button ID="btn_SupplierSubmit" runat="server" Text="Submit" Class="btn btn-success loginbtn" OnClick="btn_SupplierSubmit_Click1" ValidationGroup="PersonalGroup"/>
