    <%@ Page Title="" Language="C#" MasterPageFile="~/cake.Master" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="Gk_Cake_shop.CustomerList" %>
                                                       ...
                                                       <form action="#" id="loginForm">
                                                        <div class="row">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                                DataKeyNames="CustomerId" OnRowCommand="GridView1_RowCommand" CssClass="table table-bordered table-responsive" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="10" AllowPaging="true" PagerSettings-Mode="NextPrevious" PagerSettings-NextPageText="Next" PagerSettings-PreviousPageText="Previous">
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="CustomerState" HeaderText="State" ConvertEmptyStringToNull="False" SortExpression="State" />
