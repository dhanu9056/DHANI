<%@ Page Title="" Language="C#" MasterPageFile="~/cake.Master" AutoEventWireup="true" CodeBehind="PurchaseBillReport.aspx.cs" Inherits="Gk_Cake_shop.PurchaseBillReport" %>
                                                    ...
                                                    <div class="review-content-section">
                                                        <div id="dropzone1" class="pro-ad addcoursepro">
                                                            ...
                                                            <asp:Label ID="lbl_Error" runat="server" ForeColor="Red" Font-Bold="true" Font-Size="Large"></asp:Label>
                                                                <div class="row">
                                                                   ...
                                                                   <div class="form-group col-lg-2">
                                                                       <asp:Button ID="btn_Search" runat="server" Text="Search" class="btn btn-success loginbtn" OnClick="btn_Search_Click1"/>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyName="BillId"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="SupplierId" HeaderText="SupplierId" ConvertEmptyStringToNull="False" SortExpression="SupplierId" />
