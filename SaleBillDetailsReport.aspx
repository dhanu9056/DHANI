<%@ Page Title="" Language="C#" MasterPageFile="~/cake.Master" AutoEventWireup="true" CodeBehind="SaleBillDetailsReport.aspx.cs" Inherits="Gk_Cake_shop.SaleBillDetailsReport" %>
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-lg-3">
                                                            <asp:Label ID="lbl_SaleBillId" runat="server" Text="Bill Id" Font-Bold="true"></asp:Label>
                                                            <asp:TextBox ID="txt_SaleBillId" runat="server" Class="form-control" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    
                                                        <div class="form-group col-lg-3">
                                                            <asp:Label ID="lbl_SaleBillNo" runat="server" Text="Bill No" Font-Bold="true"></asp:Label>
                                                            <asp:TextBox ID="txt_SaleBillNo" runat="server" Class="form-control" ReadOnly="true"></asp:TextBox>

                                                        </div>
                                                        <div class="form-group col-lg-3">
                                                            <asp:Label ID="lbl_SaleBillDate" runat="server" Text="Bill Date" Font-Bold="true"></asp:Label>
                                                            <asp:TextBox ID="txt_SaleBillDate" runat="server" Class="form-control" ReadOnly="true"></asp:TextBox>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-lg-3">
                                                            <asp:Label ID="lbl_CustomerId" runat="server" Text="Customer Name" Font-Bold="true"></asp:Label>
                                                        ...
                                                        <div class="form-group col-lg-3">
                                                            ...
                                                            <asp:TextBox ID="txt_SaleBillMode" runat="server" Class="form-control" ReadOnly="true"></asp:TextBox>
                                                        </div>
