<%@ Page Title="" Language="C#" MasterPageFile="~/cake.Master" AutoEventWireup="true" CodeBehind="PurchasePayment.aspx.cs" Inherits="Gk_Cake_shop.PurchasePayment" %>
            ...
            <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       <div class="review-content-section">
                            ...
                            <asp:Label ID="lbl_PurchasePaymentError" runat="server" ForeColor="Red" Font-Bold="true" Font-Size="Large"></asp:Label>
                            <div class="row">
                                <div class="form-group col-lg-3">
                                      <asp:Label ID="lbl_SupplierName" runat="server" Text="Supplier Name" Font-Bold="true"></asp:Label>
                                      <asp:DropDownList ID="ddl_SupplierName" runat="server" Class="form-control" AppendDataBoundItems="true" OnSelectedIndexChanged="ddl_SupplierName_SelectedIndexChanged" AutoPostBack="true">
                                            ...
                                            <div class="basic-login-inner">
                                                <form action="#">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                               <asp:Label ID="lbl_PayementDate" runat="server" Text="Payment Date" Font-Bold="true"></asp:Label>
                                                            </div>
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
