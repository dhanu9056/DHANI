<%@ Page Title="" Language="C#" MasterPageFile="~/cake.Master" AutoEventWireup="true" CodeBehind="SaleBillDetails.aspx.cs" Inherits="Gk_Cake_shop.SaleBillDetails" %>
                                                    ...
                                                    <div class="row">
                                                            <div class="form-group col-lg-12">
                                                                ...
                                                                <div class="add-product">
                                                                     <a href="SellBill.aspx">ADD</a>
                                                                 </div>
                                                            </div>
                                                     </div>
                                                        <asp:Label ID="lbl_SaleBillDetailListError" runat="server"></asp:Label>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  DataKeyNames="BillId"
                                                                  CssClass="table table-bordered table-responsive" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="10" AllowPaging="true" PagerSettings-Mode="NextPrevious" PagerSettings-NextPageText="Next" PagerSettings-PreviousPageText="Previous">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="CustomerId" HeaderText="CustomerId" ConvertEmptyStringToNull="False" Visible="false" SortExpression="CustomerId" />
                                                                        <asp:BoundField DataField="Name" HeaderText="Customer Name" ConvertEmptyStringToNull="False" SortExpression="Name" />
